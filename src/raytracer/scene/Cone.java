...
public class Cone extends RtScene {
    public Cone() {
        ...
        // Planes
        world.addGeometry(new Plane(new Point3(0, 0, -1), new Normal3(0, 0, 1), new LambertMaterial(new ImageTexture(TextureStock.XMAS_CARPET))));
        world.addGeometry(new Plane(new Point3(-3, 0, 0), new Normal3(1, 0, 0), new LambertMaterial(new ImageTexture(TextureStock.WALL))));
        // Nails
