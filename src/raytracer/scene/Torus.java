...
//        cam = new StereoCamera(new Point3(10, 10, 10), new Vector3(-1, -1, -1), new Vector3(0, 0, 1), Math.PI / 4, 2, true);
        ...
        world.addGeometry(new raytracer.geometry.Torus(3, 1, new PhongMaterial(new Color(1, 0.6, 0), new Color(1, 1, 1), 64)));
        world.addGeometry(new raytracer.geometry.Torus(4.2, 0.1, new PhongMaterial(new Color(1, 1, 1), new Color(1, 1, 1), 64)));
        world.addGeometry(new Sphere(new Point3(3, 0, 0), 1.1, new PhongMaterial(new Color(1, 1, 1), new Color(1, 1, 1), 64)));
        world.addGeometry(new Sphere(new Point3(-3, 0, 0), 1.1, new PhongMaterial(new Color(1, 1, 1), new Color(1, 1, 1), 64)));
