...
public class ExExSpheres extends RtScene {
    public ExExSpheres() {
        ...
        world.addGeometry(new Sphere(new Point3(-3, 1, 0), 1, new LambertMaterial(new SingleColorTexture(new Color(1, 0, 0)))));
        world.addGeometry(new Sphere(new Point3(0, 1, 0), 1, new LambertMaterial(new SingleColorTexture(new Color(0, 1, 0)))));
        world.addGeometry(new Sphere(new Point3(3, 1, 0), 1, new LambertMaterial(new SingleColorTexture(new Color(0, 0, 1)))));
