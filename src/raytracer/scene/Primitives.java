...
public class Primitives extends RtScene {
    public Primitives() {
        ...
        world.addGeometry(new Plane(new Point3(0, 0, -0.5), new Normal3(0, 0, 1), new PhongMaterial(new Color(0, 0, 1), new Color(1, 1, 1), 64)));
        world.addGeometry(new raytracer.geometry.Torus(2, 0.5, new PhongMaterial(new Color(1, 0, 0), new Color(1, 1, 1), 64)));
        world.addGeometry(new Sphere(new Point3(3, -3, 0.5), 1, new PhongMaterial(new Color(0, 1, 1), new Color(1, 1, 1), 64)));
        world.addGeometry(new AxisAlignedBox(new Point3(-4, -6, -0.5), new Point3(-1, -4, 4), new PhongMaterial(new Color(1, 0, 1), new Color(1, 1, 1), 64)));
        world.addGeometry(new ZAxisAlignedCylinder(new Point3(-6, -2, -0.5), 4, 1.5, new PhongMaterial(new Color(0, 1, 0), new Color(1, 1, 1), 64)));
        world.addGeometry(new ZAxisAlignedCone(new Point3(-5, 4, 5), -5.5, -2, 3, new PhongMaterial(new Color(1, 1, 0), new Color(1, 1, 1), 64)));
