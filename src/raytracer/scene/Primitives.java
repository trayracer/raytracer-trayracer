...
public class Primitives extends RtScene {
    public Primitives() {
        ...
        world.addGeometry(new Plane(new Point3(0, 0, -0.5), new Normal3(0, 0, 1), new PhongMaterial(new ImageTexture(TextureStock.LAWN),new SingleColorTexture( new Color(1, 1, 1)), 64)));
        ...
        world.addGeometry(new AxisAlignedBox(new Point3(-4, -6, -0.5), new Point3(-1, -4, 4), new PhongMaterial(new ImageTexture(TextureStock.METAL), new SingleColorTexture(new Color(0, 0, 0)), 64)));
