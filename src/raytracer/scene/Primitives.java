...
public class Primitives extends RtScene {
    public Primitives() {
        ...
        world.addGeometry(new Sphere(new Point3(3, -3, 0.5), 1, new PhongMaterial(new SingleColorTexture(new Color(0, 1, 1)), new SingleColorTexture(new Color(1, 1, 1)), 64)));
        ...
        world.addGeometry(new ZAxisAlignedCylinder(new Point3(-6, -2, -0.5), 4, 1.5, new PhongMaterial(new SingleColorTexture(new Color(0, 1, 0)), new SingleColorTexture(new Color(1, 1, 1)), 64)));
