...
public class Primitives extends RtScene {
    public Primitives() {
        ...
        world.addGeometry(new ZAxisAlignedCone(new Point3(-5, 4, -0.5), 5.5, 0, 2.5, new PhongMaterial(new ImageTexture(TextureStock.WAFFLE), new SingleColorTexture(new Color(1, 1, 1)), 64)));
