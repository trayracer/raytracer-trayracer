...
/**
 * This class represents demo-scene Nr. 4 for exercise 3.
 *
 * @author Oliver Kniejski
 */
public class Ex3v4 extends RtScene {
    public Ex3v4() {
        ...
        world.addLight(new DirectionalLight(new Color(1, 1, 1), new Vector3(-1, -1, -1), false));
