...
public class MirrorHall extends RtScene{
    public MirrorHall() {
        cam = new PerspectiveCamera(new Point3(9.9, 2, 3), new Vector3(-1, 0.1, 0), new Vector3(0, 0, 1), Math.PI /4);
        world = new World(new Color(0, 0, 0.2), new Color(0.1, 0.1, 0.1));
        Material mirror = new ReflectiveMaterial(new Color(0.01, 0.05, 0.01), new Color(0, 0, 0), 64, new Color(1, 1, 1));
        ...
        world.addGeometry(new Plane(new Point3(0, 0, 0), new Normal3(0, 0, 1), new ReflectiveMaterial(new Color(0.5, 0.5, 0.5), new Color(0.8, 0.8, 0.8), 64, new Color(0.5, 0.5, 0.5))));
        world.addGeometry(new Sphere(new Point3(5, 6, 1), 1, new PhongMaterial(new Color(0, 0, 1), new Color(1, 1, 1), 64)));
